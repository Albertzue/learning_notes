...
44. https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-state.html   Systems Manager State Manager can not detect RDS database encryption configuration drif
